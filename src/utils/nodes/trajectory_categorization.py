    ...
    def run(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for track_id, traj_array in trajectories.items():
            ...
            traj_data = {
                ...
                "puntos": puntos_lista,
                "frames": frames_lista # 🚀 NUEVO: Lo inyectamos al JSON final
            }
            
            resultados_dict[str(track_id)] = traj_data
            trayectorias_list.append(traj_data)

        # 5. Guardamos el formato legacy en disco SOLO si se provee un nombre de archivo
        ...
        paciencia_optima = context.get("optimal_patience", 15) # Recuperamos el valor del GridSearch
        
        context["json_resultados"] = {
            "trayectorias": trayectorias_list,
            "optimal_patience": paciencia_optima # Lo añadimos al JSON que viaja al frontend
        }
